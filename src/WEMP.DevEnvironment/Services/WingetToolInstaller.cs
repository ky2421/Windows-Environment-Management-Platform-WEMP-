...
public sealed class WingetToolInstaller : IToolInstaller
{
    private static readonly IReadOnlyDictionary<string, string> PackageIdMap =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["cpp"] = "Microsoft.VisualStudio.2022.BuildTools",
            ["php"] = "PHP.PHP",
            ...
            ["deno"] = "DenoLand.Deno",
            ["bun"] = "Oven-sh.Bun",
            ["ruby"] = "RubyInstallerTeam.RubyWithDevKit.3.2",
            ["qt"] = "Qt.Qt",
            ["dart"] = "Google.DartSDK",
            ...
            ["sqlserver"] = "Microsoft.SQLServer.2022.Developer",
            ["wsl"] = "Microsoft.WSL",
            ["nginx"] = "nginxinc.nginx",
            ["arduino"] = "ArduinoSA.IDE.stable",
